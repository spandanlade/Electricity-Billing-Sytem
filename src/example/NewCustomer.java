...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer(){
        ...
        JPanel p = new JPanel();
        p.setBorder(new LineBorder(Color.WHITE, 3, true));
        p.setLayout(null);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String meter_location = "Inside";
            String meter_type = "Electronic";
            String phase_code = "1";
            String bill_type = "Normal";
            String days = "30";
            ...
            String q3 = "insert into meter_info values('"+meter_location+"','"+meter_type+"','"+phase_code+"','"+bill_type+"','"+days+"','"+meter+"')";
